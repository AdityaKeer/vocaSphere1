...
class TaLvl6 extends StatefulWidget {
  const TaLvl6({super.key});

  @override
  State<TaLvl6> createState() => _TaLvl6State();
}

class _TaLvl6State extends State<TaLvl6> {
  List<dynamic>? data;
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Icon(MingCute.translate_2_fill, size: 35),
                    SizedBox(width: 10),
