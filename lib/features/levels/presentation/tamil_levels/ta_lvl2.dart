...
class TaLvl2 extends StatefulWidget {
  const TaLvl2({super.key});
  @override
  State<TaLvl2> createState() => _TaLvl2State();
}

class _TaLvl2State extends State<TaLvl2> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text('Tamil Constants', style: theme.textTheme.titleLarge),
                  Spacer(),
                  Text(
                    '${_currentPage + 1}/18',
