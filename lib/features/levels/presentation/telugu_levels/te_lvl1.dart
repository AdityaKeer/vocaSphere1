...
class TeLvl1 extends StatefulWidget {
  const TeLvl1({super.key});
  @override
  State<TeLvl1> createState() => _TeLvl1State();
}

class _TeLvl1State extends State<TeLvl1> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text('Telugu Vowels', style: theme.textTheme.titleLarge),
                  Spacer(),
                  Text(
                    '${_currentPage + 1}/15',
