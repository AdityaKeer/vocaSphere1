...
import 'package:major_project1/features/languages/presentation/pages/telugu/page/telugu_page.dart';
...
class TeLvl3 extends StatefulWidget {
  const TeLvl3({super.key});

  @override
  State<TeLvl3> createState() => _TeLvl3State();
}

class _TeLvl3State extends State<TeLvl3> with SingleTickerProviderStateMixin {
