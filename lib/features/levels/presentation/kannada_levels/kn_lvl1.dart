...
class KnLvl1 extends StatefulWidget {
  const KnLvl1({super.key});
  @override
  State<KnLvl1> createState() => _KnLvl1State();
}

class _KnLvl1State extends State<KnLvl1> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Text('Kannada Vowels', style: theme.textTheme.titleLarge),
                  Spacer(),
                  Text(
                    '${_currentPage + 1}/15',
